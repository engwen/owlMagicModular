...
public abstract class ObjectUtil {
    ...
    public static Object getProValue(String proName, Object obj) throws Exception {
        ...
        Field[] fields = FieldUtil.getSupperClassProperties(obj);
    ...
    public static <T, K> K setThisObjToAnotherObj(T oldObj, K newObj) {
        Field[] oldFields = FieldUtil.getSupperClassProperties(oldObj);
        Field[] newFields = FieldUtil.getSupperClassProperties(newObj);
